...
function loadGame() {
  ...
  try {
    ...
    gameState.resources = { ...base.resources, ...(parsed.resources || {}) };
    gameState.villagers = { ...base.villagers, ...(parsed.villagers || {}) };
    gameState.season = { ...base.season, ...(parsed.season || {}) };
    gameState.meta = { ...base.meta, ...(parsed.meta || {}) };
    gameState.market = {
      ...base.market,
      ...(parsed.market || {}),
      autoSell: {
        ...base.market.autoSell,
        ...((parsed.market || {}).autoSell || {}),
      },
    };
    gameState.labor = { ...base.labor, ...(parsed.labor || {}) };
    gameState.world = { ...base.world, ...(parsed.world || {}) };
    gameState.quests = {
      ...base.quests,
      ...(parsed.quests || {}),
      completed: {
    ...
    gameState.buildings = {
      ...
      woodcutter: {
        ...
        ...((parsed.buildings || {}).woodcutter || {}),
        upgrades: {
          ...base.buildings.woodcutter.upgrades,
          ...(((parsed.buildings || {}).woodcutter || {}).upgrades || {}),
        },
      },
      farm: {
        ...base.buildings.farm,
        ...((parsed.buildings || {}).farm || {}),
        upgrades: {
          ...base.buildings.farm.upgrades,
          ...(((parsed.buildings || {}).farm || {}).upgrades || {}),
        },
      },
      quarry: {
        ...base.buildings.quarry,
        ...((parsed.buildings || {}).quarry || {}),
        upgrades: {
          ...base.buildings.quarry.upgrades,
          ...(((parsed.buildings || {}).quarry || {}).upgrades || {}),
        },
      },
      housing: {
        ...base.buildings.housing,
        ...((parsed.buildings || {}).housing || {}),
        upgrades: {
          ...base.buildings.housing.upgrades,
          ...(((parsed.buildings || {}).housing || {}).upgrades || {}),
        },
      },
    };
